...
public class ProgramParser/*@bgen(jjtree)*/implements ProgramParserTreeConstants, ProgramParserConstants {/*@bgen(jjtree)*/
  ...
  * command line call
  */
  public static void main(String[] args) throws ParseException, InterpreterException, inputparser.ParseException {
    if (args.length == 2) {
  ...
  * run program
  */
  public Data runProgram() throws ParseException, InterpreterException, inputparser.ParseException {
    //parse input
    dataInput = inputparser.InputParser.run(stringInput);
...
*/
  final public void progname() throws ParseException {/*@bgen(jjtree) progname */
