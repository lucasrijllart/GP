...
public class ProgramVisitor implements ProgramParserVisitor {
    ...
    //initialiseRandomPopulation of interpreting
    ...
    public Object visit(ASToutput node, Object data) /*throws InterpreterException*/ {
        ...
        if (getVarName instanceof String) {
            ...
            if (symbolTable.containsKey(varName)) { //if does exists
                ...
                throw new UnsupportedOperationException("New variable on output");
            }
        }
    ...
    public Object visit(ASTWhile node, Object data) {
        ...
        while (expr.getData() instanceof Tree && whilecounter < 100) {
        ...
        if (whilecounter >= 100) {
            ...
            throw new UnsupportedOperationException("While loop does not terminate");
        }
        return null;
    }
    ...
    public Object visit(ASTEqual node, Object data) {
        ...
        Data expr2 = stack.pop();
        /*
         long initialiseRandomPopulation = System.currentTimeMillis();
         ...
         System.out.println("equals time: " + (System.currentTimeMillis() - initialiseRandomPopulation) + "ms");
         */

        //initialiseRandomPopulation = System.currentTimeMillis();
        ...
        //System.out.println("equali time: " + (System.currentTimeMillis() - initialiseRandomPopulation) + "ms");
    ...
    public Object visit(ASTMacro node, Object data) {
        ...
        try {
            ...
            } catch (inputparser.ParseException ex) {
